...
const steps = [
  {
    target: "#name",
    content: "Nhập tên ở chỗ này nè Giang.",
    placement: "bottom",
    disableBeacon: true,
  },
  {
    target: "#candle",
    content: "Cố gắng thổi phù phù vào cái nến đang cháy nhen.",
    placement: "bottom",
  },
  {
    target: "#start",
    content: "Ấn vào nút Start để bật đèn và nhạc lên xập xình nhen.",
    placement: "top",
  },
  {
    target: "#pause",
    content: "Ấn nút Dừng để tắt nhạc nếu em không thích :(.",
    placement: "top",
  },
  {
    target: "#stop",
    content: "Ấn Dừng lại nếu muốn tắt nó tạm thời.",
    placement: "top",
  },
  {
    target: "#toggle-candle",
    content: "Ấn nút này nếu em muốn thổi nến nhen.",
    placement: "top",
  },
  {
    target: "#share",
    content: "Đổi tên của em hay muốn Share cho bạn bè nhen. ahihi",
    placement: "top",
  },
...
function App() {
  ...
  const blowCandles = useCallback(async (stream: MediaStream) => {
    try {
      ...
      console.error("Lỗi kết nối Microphone:", error);
    }
  }, []);
